...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside className={cn(
                'fixed left-0 top-0 z-40 h-screen bg-white/60 backdrop-blur-3xl border-r border-white/50 shadow-[4px_0_24px_rgba(142,179,122,0.05)]',
                ...
                <div className="flex flex-col h-full">
                    ...
                    <nav className="flex-1 px-3 py-4 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                        {navGroups.map((group, gi) => (
                            <div key={group.label} className={cn('mb-4', gi > 0 && 'pt-2 border-t border-white/60')}>
                                {!isCollapsed && (
            ...
            <button
                ...
                className={cn(
                    ...
                    'bg-white/60 backdrop-blur-md border border-white/60 rounded-r-xl',
