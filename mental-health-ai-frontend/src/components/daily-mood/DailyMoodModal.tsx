        ...
        >
            ...
            >
                ...
                <div className={`relative bg-linear-to-r ${moodInfo.gradient} p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700`}>
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-3 sm:gap-4 min-w-0">
                            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-white/80 dark:bg-gray-800/80 shadow-sm flex items-center justify-center text-2xl sm:text-4xl shrink-0 backdrop-blur-sm">
                                {moodInfo.emoji}
                            </div>
                            <div className="min-w-0">
                                <h2 className={`text-lg sm:text-2xl font-bold ${moodInfo.color} flex flex-wrap items-center gap-2`}>
                                    {moodInfo.label}
                ...
                <div className="p-4 border-t border-gray-100 dark:border-gray-700 bg-emerald-50/30 dark:bg-emerald-900/10 flex items-center justify-center gap-2">
                    <Heart className="w-3 h-3 text-emerald-500/40 fill-emerald-500/10" />
