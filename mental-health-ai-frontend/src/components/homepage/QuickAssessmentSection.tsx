...
export default function QuickAssessmentSection() {
    ...
    return (
        <section id="assessment" className="relative overflow-hidden bg-linear-to-br from-sky-50/50 via-background to-blue-50/30 py-12 px-4 sm:px-6 lg:px-8 ">
            <div className="absolute -top-10 -right-10 h-64 w-64 rounded-full bg-primary/10 blur-3xl" aria-hidden />
            <div className="absolute -bottom-10 -left-10 h-64 w-64 rounded-full bg-sky-300/20 blur-3xl" aria-hidden />
