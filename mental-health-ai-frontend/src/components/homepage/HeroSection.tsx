...
export default function HeroSection() {
    return (
        <section className="relative isolate overflow-hidden bg-white pb-8 lg:pb-12">
            ...
            <div className="absolute -left-20 top-20 h-72 w-72 rounded-full bg-sky-300/20 blur-3xl animate-pulse-soft" aria-hidden />
            <div className="absolute -right-20 bottom-20 h-80 w-80 rounded-full bg-primary/15 blur-3xl animate-float" aria-hidden />
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-24 grid gap-16 lg:grid-cols-2 items-center relative z-10">
                <div className="space-y-8 animate-in fade-in slide-in-from-left duration-1000 text-center lg:text-left flex flex-col items-center lg:items-start">
                    <div className="inline-flex items-center gap-2 rounded-full bg-sky-50/80 px-4 py-2 shadow-sm border border-sky-100 backdrop-blur-md">
                        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-sky-100 text-sky-600 animate-pulse-soft">
                    ...
                    <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold leading-[1.1] text-foreground tracking-tight">
