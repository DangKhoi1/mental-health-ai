            ...
            <div className="w-full max-w-sm sm:max-w-md relative z-10 mx-auto">
                <div className="text-center mb-4 sm:mb-5">
                    <Link href="/" className="inline-flex items-center gap-2 group">
                        <div className="size-10 sm:w-11 sm:h-11 rounded-xl bg-primary flex items-center justify-center transition-transform group-hover:scale-105 shadow-md">
                            <Image src="/mental_health.png" alt="Logo" width={32} height={32} className="size-8 brightness-0 invert" />
                        </div>
