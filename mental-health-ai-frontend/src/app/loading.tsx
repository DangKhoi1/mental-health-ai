  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-teal-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className="relative">
        <div className="size-16 border-4 border-teal-200 dark:border-teal-900 rounded-full animate-pulse" />
        <div className="absolute top-0 left-0 size-16 border-4 border-transparent border-t-teal-500 rounded-full animate-spin" />
      </div>
